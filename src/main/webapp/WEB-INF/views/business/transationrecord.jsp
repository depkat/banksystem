...
<%--                    </button>--%>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6" id="page_nav_area">
                        ...
                        <nav>
                            <ul class="pagination">
                                <li id="firstPageLi"><a href="${APP_PATH}/transationRecord">首页</a></li>
                                <li id="prePageLi"><a href="${APP_PATH}/transationRecord?pn=${data.pageNum - 1}">«</a></li>
                                <li id="li1"><a href="${APP_PATH}/transationRecord?pn=${data.pageNum - 2}">${data.pageNum - 2} </a></li>
                                <li id="li2"><a href="${APP_PATH}/transationRecord?pn=${data.pageNum - 1}">${data.pageNum - 1} </a></li>
                                <li id="li3" class="active"><a>${data.pageNum}</a></li>
                                <li id="li4"><a href="${APP_PATH}/transationRecord?pn=${data.pageNum + 1}">${data.pageNum + 1} </a></li>
                                <li id="li5"><a href="${APP_PATH}/transationRecord?pn=${data.pageNum + 2}">${data.pageNum + 2 }</a></li>
                                <li id="nextPageLi"><a href="${APP_PATH}/transationRecord?pn=${data.pageNum + 1}">»</a></li>
                                <li id="lastPageLi"><a href="${APP_PATH}/transationRecord?pn=${data.pages}">末页</a></li>
                            </ul>
                        </nav>
                    </div>
                </div>
